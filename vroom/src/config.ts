...
export const STAND = {
  ...
  /** How many of them are wearing a hat, and how many are waving a flag,
   *  both in one of the crowd's colours. */
  hats: 0.22,
  flags: 0.16,
  /**
   * The celebration.
...
export const ENGINE = {
  ...
  yellowHue: 0.12,
  /** The red and the yellow a rival tank engine is painted: the garage's own,
   *  so they are the same red and yellow a child can choose. */
  red: 0xd6473c,
  yellow: 0xe0b13c,
  reddish: 0.05,
  black: 0x1a1b1f,
