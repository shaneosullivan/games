...
export class Scenery {
  ...
  /**
   * The skyline: towers with their lights on, beyond the barrier.
   *
  ...
  private city(
    ...
    const put = (low: boolean, band: number, from: number): void => {
      ...
      // Nothing is registered with the light pool. The windows are lit and
      // they light nothing: see `NEON.window`.
      void height;
    };
